...
export class CourseService {
  ...
  constructor(){
    this.courses = [
      ...
      {
        id: 2,
        name: 'Learn Full Stack Web Development From Scratch',
        description: 'This is full Stack Web Development Course for Absolute Beginners 2022. A 22 hour video covering all the major topics of web development. Become a full-stack web developer from this complete course from scratch for mastering web development in 2022.',
        price: 0,
        duration: 21,
        rating: 4.7,
        imageUrl: 'https://i.ytimg.com/vi/ZxKM3DCV2kE/hqdefault.jpg?sqp=-oaymwEXCNACELwBSFryq4qpAwkIARUAAIhCGAE=&rs=AOn4CLBuqE2MIjRtkk7M2l-JNcZnIVN1cA',
        playlist: [
          {
            id: 1,
            name: 'Web Development Full Course - 22 Hour Course | Learn Full Stack Web Development From Scratch',
            duration: 10,
